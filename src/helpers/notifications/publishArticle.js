  ...
  try {
    ...
    return followers.map(async (follower) => {
      const message = `
        ...
        <br><br><br>
        <a href='${APP_URL_FRONTEND}/articles/${articleSlug}' style="margin:35px 0;padding:15px 35px;background:#266cef;color:#ffffff;clear:both;border-radius:30px;text-decoration:none" target='_blank'>Read Now</a></p>`;
